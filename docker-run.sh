...
echo ""
echo -e "Try it with: ${YELLOW}curl 'http://localhost:5000/api/convert?url=https://calendar.google.com/calendar/ical/en.usa%23holiday%40group.v.calendar.google.com/public/basic.ics'${NC}"
echo ""
